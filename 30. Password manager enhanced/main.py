...
def find_password():
    ...
    if len(website) == 0:
        ...
        return
    try:
        with open(r"C:\Code\100DaysCourse\30. Password manager enhanced\data.json", "r") as file:
            data = json.load(file)
...
def save():
    ...
    try: 
        ...
        with open(r"C:\Code\100DaysCourse\30. Password manager enhanced\data.json", "w") as file:
...
photo_image = PhotoImage(file=r"C:\Code\100DaysCourse\30. Password manager enhanced\logo.png")
